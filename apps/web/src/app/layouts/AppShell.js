...
export function AppShell({ children }) {
  return _jsx('div', {
    className: 'min-h-screen px-4 py-6 text-ink sm:px-6 lg:px-8',
    children: _jsxs('div', {
      className: 'mx-auto flex w-full max-w-7xl flex-col gap-6 lg:flex-row',
      children: [
        _jsxs('aside', {
          className: 'glass-panel w-full overflow-hidden lg:max-w-xs',
          children: [
            _jsxs('div', {
              className: 'border-b border-slate-200/70 px-6 py-6',
              children: [
                _jsx('p', {
              ...
              children: navigationItems.map((item) =>
                _jsxs(
                  NavLink,
                  {
                    ...
                    children: [
                      _jsx('span', { className: 'block', children: item.label }),
                      _jsx('span', {
