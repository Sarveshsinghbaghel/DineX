...
export const PERMISSION_CATALOG: PermissionDefinition[] = [
  ...
  },
  {
    ...
    action: 'read',
    scope: 'tenant',
    description: 'Read permissions catalog',
  },
  {
  ...
  // Menu Management
  {
    ...
    action: 'read',
    scope: 'tenant',
    description: 'Browse and search menu items',
  },
  {
    code: 'menu.create',
    module: 'menu',
  ...
  // Kitchen Operations
  {
    code: 'kitchen.orders.read',
    module: 'kitchen',
    action: 'orders.read',
    scope: 'branch',
    description: 'Read kitchen display order queue',
  },
  {
    code: 'kitchen.orders.update',
    module: 'kitchen',
    action: 'orders.update',
    scope: 'branch',
    description: 'Update kitchen order state (accept, prepare, ready)',
  },
  ...
  // Reservations
  {
    ...
    action: 'read',
    scope: 'branch',
    description: 'Read table reservations',
  },
  {
  ...
  },
  {
    ...
    action: 'update',
    scope: 'branch',
    description: 'Update table reservations',
  },
  {
    ...
    action: 'cancel',
    scope: 'branch',
    description: 'Cancel table reservations',
  },
  {
    code: 'reservations.own.read',
    module: 'reservations',
    action: 'own.read',
    scope: 'own',
    description: 'Read own reservations',
  },
  {
    code: 'reservations.own.create',
    module: 'reservations',
    action: 'own.create',
    scope: 'own',
    description: 'Create own reservations',
  },
  ...
  {
    code: 'payments.own.read',
    module: 'payments',
    action: 'own.read',
    scope: 'own',
    description: 'Read own payment receipts',
  },
  ...
  // Inventory Management
  {
    ...
    action: 'read',
    scope: 'restaurant',
    description: 'Read inventory levels and ingredients',
  },
  {
  ...
  {
    code: 'recommendations.read',
    module: 'recommendations',
    action: 'read',
    scope: 'restaurant',
    description: 'View staff recommendation insights',
  },
  {
    code: 'tables.read',
    module: 'tables',
    action: 'read',
    scope: 'branch',
    description: 'View tables and QR tokens',
  },
  {
    code: 'tables.manage',
    module: 'tables',
    action: 'manage',
    scope: 'branch',
    description: 'Manage tables and QR tokens',
  },
  ...
  // Settings & System Configuration
  {
    ...
    action: 'read',
    scope: 'restaurant',
    description: 'Read restaurant and branch settings',
  },
  {
...
export const DEFAULT_ROLE_PERMISSIONS: Record<SystemRoleCode, string[]> = {
  ...
  [SYSTEM_ROLES.SUPER_ADMIN]: ['system.doEverything', ...PERMISSION_CATALOG.map((p) => p.code)],
};
